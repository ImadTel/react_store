    ...
    return(
        <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3  "  >
            <div className="card card-cont"  >
                <div className="img-container p-5 img-card-container " onClick ={()=>props.handleDetail(id)  } >
                <Link to="/details" >
                ...
                <div className="card-footer d-flex justify-content-between  align-items-center footer-card " > 
